...
int main(int argc, char **argv) {
  ...
  MobiusEOFAFermionD Strange_Op_L(U, *FGrid, *FrbGrid, *GridPtr, *GridRBPtr, m_f,     m_f, pv_mass,  0.0, -1, M5, b, c);
  MobiusEOFAFermionD Strange_Op_R(U, *FGrid, *FrbGrid, *GridPtr, *GridRBPtr, pv_mass, m_f, pv_mass, -1.0,  1, M5, b, c);
