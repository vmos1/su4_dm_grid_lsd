...
#SBATCH -t 00:10:00
#SBATCH -J Benchmark_dwf_fp32_2nodes
#SBATCH -o Benchmark_dwf_fp32_2nodes.%J
#SBATCH -e Benchmark_dwf_fp32_2nodes.%J
#SBATCH -N 2
#SBATCH -n 8
#SBATCH --exclusive
...
srun --gpus-per-task 1 -n16 $BIND ./wrap.sh  $SETUP_DIR/install/build-Nc4/benchmarks/Benchmark_dwf_fp32 $PARAMS
